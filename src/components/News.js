...
export class News extends Component {
   ...
   async componentDidMount(){
        let url = "https://newsapi.org/v2/top-headlines?country=in&apiKey=950cebd1522546c098dea27ea833d5da";
    ...
    handlePrevClick= async ()=>{
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=950cebd1522546c098dea27ea833d5da&page=${this.state.page-1}`;
        let data =await fetch(url);
        let parsedData = await data.json()
        console.log(parsedData);
        this.setState({
    ...
    render() {
        return (
            <div className="container my-3">
                <h1>Top headlines - Hot News For You</h1>
                <div className="row">
